...
export default function ProductsView({ language }: ProductsViewProps) {
  ...
  const features = [
    {
      img: imgS3,
      title: isTH ? 'ระบบล็อกแยกชั้นอิสระ' : 'Independent Dual-Tier Lock',
      desc: isTH
    ...
    {
      img: imgS1,
      title: isTH ? 'เชื่อมต่อเครื่องพิมพ์สลิปอัตโนมัติ' : 'Auto-Connect Receipt Printer',
      desc: isTH
    ...
    {
      img: imgS2,
      title: isTH ? 'โครงสร้างเหล็กแข็งแกร่ง ขนาดกะทัดรัด' : 'Heavy-Duty Steel, Compact Design',
      desc: isTH
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-5">
            ...
            <div className="flex flex-col items-center gap-3 py-4">
              <p className="text-3xl font-black text-[#131C45]">
                {isTH ? 'ติดต่อสอบถามราคา' : 'Contact for Price'}
              </p>
              <a
                href="https://line.me/R/ti/p/@growstore"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 bg-[#06C755] hover:bg-[#05b34d] transition-colors text-white font-bold text-lg px-8 py-4 rounded-xl shadow-md"
              >
